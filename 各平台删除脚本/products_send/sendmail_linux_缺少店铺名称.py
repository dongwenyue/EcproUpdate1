...
table_head = ["发布ID", "用户", "货号", "类目ID", "类目名称", "商品ID", "平台", "店铺ID", "上货失败", "同步失败", "上货链接"]
...
if __name__ == '__main__':
    ...
    sql = "SELECT	publish.id,	publish.account_id, product.CODE,	product.category_id,	product.category_path,	" \
          "publish.product_id,	tp.NAME,	publish.shop_id, publish.pub_description,	publish.sync_description FROM	publish	LEFT " \
